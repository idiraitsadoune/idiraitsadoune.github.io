function main_plan() {
    ...
    const outlook_div = document.createElement("div");
    outlook_div.setAttribute("data-id", "menu");
    outlook_div.setAttribute("class", "outlook");

    ul_element.appendChild(outlook_div);

    for (let i = 0; i < sections_name.length; i++) {
        const item_div = document.createElement("div");
        item_div.setAttribute("class", "item");
        outlook_div.appendChild(item_div);
