...
\begin{tikzpicture}
    ...
    \node[dev-step, color=orange, fill=orange] (tests-unitaires) at (2.4,1.1) {\textcolor{white}{Tests unitaires}};
    ...
    \node[dev-step, color=orange, fill=orange] (tests-integration) at (3,2.2) {\textcolor{white}{Tests d'intégration}};
    ...
    \node[dev-step, color=orange, fill=orange] (tests-validation) at (3.6,3.3) {\textcolor{white}{Tests de validation}};
    ...
    \node[dev-step, color=orange, fill=orange] (tests-acceptation) at (4.2,4.4) {\textcolor{white}{Tests d'acceptation}};
