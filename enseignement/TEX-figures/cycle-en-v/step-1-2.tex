...
\begin{tikzpicture}
    ...
    \node[dev-step, color=orange, fill=orange] (specification) at (-3.6,3.3) {\textcolor{white}{Spécification}};
    ...
    \node[dev-step, color=orange, fill=orange] (analyse) at (-4.2,4.4) {\textcolor{white}{Analyse}};
