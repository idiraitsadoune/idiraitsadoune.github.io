...
%\only<2->{
    ...
    \draw[-Stealth,opacity=1.0] (2.125,-.5) to[bend right=20] (6,-.5);
%}
%\only<3->{
    ...
    %\only<3-4>{ 
        \node[opacity=0.0] at (1,0) {\small Index}; 
    %} % je le remets après le rouge
    \draw[thick,color=red,-Stealth,opacity=1.0] (2.375,.5) to[bend right=20] (1,.5);
%}
%\only<4->{
    \draw[thick,opacity=1.0] (.75,.5) to (.75,-.5);
    \draw[thick,opacity=1.0] (1,.5) to (1,-.5);
    \draw[thick,opacity=1.0] (1.25,.5) to (1.25,-.5);
    \draw[-Stealth,opacity=1.0] (.625,-.5) to[bend right=20] (8,-.5);
    \draw[-Stealth,opacity=1.0] (.875,-.5) to[bend right=20] (9,-.5);
    \draw[-Stealth,opacity=1.0] (1.125,-.5) to[bend right=20] (11,-.5);
%}
%\only<5->{
    \draw[color=red,fill=red!20,opacity=1.0] (1.25,.5) rectangle (1.5,-.5);
    ...
    \draw[thick,-Stealth,color=red,opacity=1.0] (1.375,.5) to[bend left=20] (10,.5);
