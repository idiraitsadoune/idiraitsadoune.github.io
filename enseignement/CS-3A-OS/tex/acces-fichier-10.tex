...
\begin{tikzpicture}[ultra thick]
    ...
    %}
    %\onslide<9-10>{
			\draw[dashed,-Stealth, ultra thick] (-9.5,7.6) to (-9.3,3.3);
			\draw[fill=red] (-9.4,3.3) rectangle (-9.2,2.3);
			\draw[-Stealth, ultra thick] (-9.3,2.3) to[bend left=60] (fcb);
	%}
    
	%\onslide<10> {
				\draw[thick,dashed,-Stealth, ultra thick] (fcb) to (fcb2);
				\node at (-2.8,1.2) {\textbf{accès disque}};
	%}
