...
\begin{tikzpicture}[ultra thick]
    ...
    %\only<2->{
        %\only<2>{
            \draw[thick,color=red,fill=red!20, opacity=0.0] (1.5,.5) rectangle (2.5,-.5);
        %}
        %\only<3->{
    ...
    %}
    %\only<3->{
        \draw[-Stealth, thick, color=red, opacity=1.0] (1.625,.5) to[bend right=20] (1,.5);
        \draw[-Stealth, thick, color=red, opacity=1.0] (1.875,.5) to[bend left=20] (5,.5);
        \draw[-Stealth, thick, color=red, opacity=1.0] (2.125,.5) to[bend left=20] (7,.5);
        \draw[-Stealth, thick, color=red, opacity=1.0] (2.375,.5) to[bend left=20] (10,.5);
        \draw[thick,color=red,fill=red!20, opacity=1.0] (.5,.5) rectangle (1.5,-.5);
        \node[opacity=1.0] at (1,0) {\small Index};
        \draw[thick,color=red,fill=red!20, opacity=1.0] (4.5,.5) rectangle (5.5,-.5);
        \node[opacity=1.0] at (5,0) {\small Index};
        \draw[thick,color=red,fill=red!20, opacity=1.0] (6.5,.5) rectangle (7.5,-.5);
        \node[opacity=1.0] at (7,0) {\small Index};
        \draw[thick,color=red,fill=red!20, opacity=1.0] (9.5,.5) rectangle (10.5,-.5);
    ...
    %\only<4>{
        ...
        \draw[-Stealth, opacity=1.0] (.625,-.5) to[bend right=20] (3,-.5);
        \draw[-Stealth, opacity=1.0] (.875,-.5) to[bend right=20] (4,-.5);
        \draw[-Stealth, opacity=1.0] (1.125,-.5) to[bend right=20] (6,-.5);
        \draw[-Stealth, opacity=1.0] (1.125,-.5) to[bend right=20] (8,-.5);
        ...
        \draw[-Stealth, opacity=1.0] (5.125,-.5) to[bend right=20] (14,-.5);
        \draw[-Stealth, opacity=1.0] (5.125,-.5) to[bend right=20] (15,-.5);
    %}
